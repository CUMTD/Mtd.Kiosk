...
public class LedRealtimeClient
{
	public readonly LedRealtimeClientConfig _config;
	private readonly ILogger<LedRealtimeClient> _logger;
	private readonly HttpClient _httpClient;

	public LedRealtimeClient(ILogger<LedRealtimeClient> logger, HttpClient httpClient, IOptions<LedRealtimeClientConfig> options)
	{
	...
	public async Task<bool> GetDarkModeStatusAsync(CancellationToken cancellationToken)
	{
	...
	public async Task<bool> LogHeartbeatAsync(string kioskId, CancellationToken cancellationToken)
	{
