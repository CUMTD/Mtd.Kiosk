...
/// <summary>
/// A single departure time for e-paper displays.
/// </summary>
/// <remarks>
/// Constructor that maps a generic departure to an e-paper departure time.
/// </remarks>
/// <param name="departure">The departure time to use.</param>
public class EPaperDepartureTime(Departure departure)
{
	private static readonly string[] _nonDestinationStrings = ["express"];

	/// <summary>
	/// The unique ID for this departure.
	/// </summary>
	[JsonPropertyName("uniqueId")]
	public string UniqueId { get; set; } = departure.UniqueId;
