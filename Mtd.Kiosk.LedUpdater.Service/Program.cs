...
try
{
	...
	var host = Host
		...
		.ConfigureServices((context, services) =>
		{
			...
			_ = services
				.Configure<LedRealtimeClientConfig>(context.Configuration.GetSection(LedRealtimeClientConfig.CONFIG_SECTION_NAME))
				.AddOptionsWithValidateOnStart<LedRealtimeClientConfig>(LedRealtimeClientConfig.CONFIG_SECTION_NAME)
				.Bind(context.Configuration.GetSection(LedRealtimeClientConfig.CONFIG_SECTION_NAME));
			...
			_ = services.AddScoped<LedRealtimeClient>();
